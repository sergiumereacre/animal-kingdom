...
<x-card-base class="md:flex md:flex-row md:max-w-xl md:min-w-lg">
    ...
    <div class="flex flex-col items-center py-5 md:mx-5 md:w-max md:h-max md:pt-10">
        <img class="w-36 h-36 md:h-max mb-3 rounded-full shadow-lg" src="{{ asset('img/logo.png')}}" alt="Company Logo"/>
    ...
    <div class="md:mr-5">
        ...
        <div class="flex flex-col items-center md:flex-row md:pt-8">
            ...
            <div class="flex flex-row items-center pt-5 md:pt-0 md:ml-auto mr-5 md:mr-0">
                <p class="md:pt-0 font-bold text-greenButtons ml-5 md:ml-0">{{$user->address}}</p>

<x-app-layout>
    <div>
        <form method="POST" action="/users/filter" enctype="multipart/form-data" class="p-10 flex flex-col items-center gap-5">
            ...
            <div class="flex flex-col gap-5 md:w-full">
                ...
                <div>
                    ...
                    <x-select name="eating_style_requirement" id="eating_style_requirement" class="mt-1 block w-full">
                        <option value="NULL">None</option>

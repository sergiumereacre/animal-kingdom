            ...
            <div class="p-10 flex flex-col items-center gap-5">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="grid md:grid-cols-2 gap-5">
                        <div>
                            <div class="pb-5">
                                <x-input-label for="skills">All skills vacancies should have. Please specify skill
                                    level
                                    with colon and
                        ...
                        <div>
                            <div class="pb-5">
                                <x-input-label for="qualifications">All qualifications vacanices should have. Please
                                    separate
                                    with

            ...
            <form method="POST" action="/vacancies" enctype="multipart/form-data" onsubmit="return validateForm()"
                ...
                <div class="flex flex-col gap-5 md:w-full">
                    ...
                    <div>
                        ...
                        <textarea onkeydown="limitTextArea(this, 200)" onkeyup="limitTextArea(this, 200)" name="vacancy_description" id="vacancy_description" rows="10" class="mt-1 block w-full border-gray-300 focus:border-greenButtons focus:ring-greenButtons rounded-lg shadow-md" placeholder="Description Details.">{{ old('vacancy_description') }}</textarea>

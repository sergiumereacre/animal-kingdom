...
@endphp
                    ...
                    <div>
                        ...
                        <x-text-input id="salary_lower" type="number" name="salary_range_lower" class="mt-1 block w-full" placeholder="" value="{{ $vacancy->salary_range_lower }}" required></x-text-input>
                    ...
                    <div>
                        ...
                        <x-text-input id="salary_upper" type="number" name="salary_range_upper" class="mt-1 block w-full" placeholder="" value="{{ $vacancy->salary_range_upper }}" required></x-text-input>
                    ...
                    <div>
                        ...
                        <textarea name="vacancy_description" id="vacancy_description" rows="10" class="mt-1 block w-full border-gray-300 focus:border-greenButtons focus:ring-greenButtons rounded-lg shadow-md" placeholder="Description Details.">{{ $vacancy->vacacny_description }}</textarea>

...
CREATE TABLE `animal_species` (
  ...
  `produces_toxins` tinyint(1) NOT NULL,
  `size` enum('SMALL','MEDIUM','LARGE') COLLATE utf8mb4_unicode_ci NOT NULL,
  `speed` enum('SLOW','MEDIUM','FAST') COLLATE utf8mb4_unicode_ci NOT NULL,
  `num_appendages` enum('NONE','FEW','MANY') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `vacancies` (
  ...
  `can_climb_requirement` tinyint(1) DEFAULT NULL,
  `eating_style_requirement` enum('HERBIVORE','CARNIVORE','OMNIVORE') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `produces_toxins_requirement` tinyint(1) DEFAULT NULL,
  `size_requirement` enum('SMALL','MEDIUM','LARGE') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `speed_requirement` enum('SLOW','MEDIUM','FAST') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `num_appendages_requirement` enum('NONE','FEW','MANY') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
